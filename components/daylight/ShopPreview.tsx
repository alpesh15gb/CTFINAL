...
export function ShopPreview() {
  ...
  return (
    <section className="relative border-y border-white/10 bg-[#08090b] py-24 md:py-36">
      <div className="pointer-events-none absolute inset-0 precision-grid opacity-50" />
        ...
        <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-4 md:mt-16">
          {items
            ...
            : [0, 1, 2, 3].map((i) => (
                <div
                  key={i}
                  className="h-[420px] animate-pulse rounded-sm bg-white/10"
                />
              ))}
        </div>
      </div>
