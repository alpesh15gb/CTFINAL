...
export function VehicleSelector() {
  ...
  return (
    <section
      id="vehicle-selector"
      className="relative z-30 overflow-hidden border-b border-white/10 bg-[#111318] py-24 md:py-32 lg:py-40"
    >
      <div className="precision-grid pointer-events-none absolute inset-0 opacity-60" />
      <div className="pointer-events-none absolute left-0 top-1/3 h-96 w-96 -translate-x-1/2 rounded-full bg-red/[0.12] blur-[100px]" />
      <div className="site-container relative">
        ...
        >
          ...
          <div className="max-w-xl">
            <motion.span variants={fadeInUp} className="mb-5 inline-flex items-center gap-3 font-mono text-[10px] font-bold uppercase tracking-[0.22em] text-white/55 md:text-[11px]">
            ...
            <motion.h2
              variants={fadeInUp}
              className="font-display text-6xl font-bold uppercase leading-[0.82] tracking-[-0.035em] text-white md:text-8xl"
            >
              One car.
              <br />
            ...
            {selected && (
              <motion.div
                variants={fadeInUp}
                className="premium-card edge-highlight mt-9 rounded-sm border-white/15 p-6 text-white"
              >
                <p className="font-mono text-[9px] uppercase tracking-[0.2em] text-silver-muted">
                  Selected vehicle
                </p>
                <p className="mt-2 font-display text-3xl font-semibold uppercase text-white">
          ...
          <motion.div
            variants={staggerContainer}
            className="relative space-y-8 overflow-hidden rounded-sm border border-white/10 bg-[#1a1d23] p-6 shadow-[0_24px_70px_rgba(0,0,0,0.28)] md:p-10 lg:p-12"
          >
            <div className="precision-grid pointer-events-none absolute inset-0 opacity-40" />
            {/* Brand */}
  ...
  return (
    <motion.div variants={fadeInUp} className={cn("relative space-y-3", disabled && "opacity-45")}>
      <div className="flex items-center gap-3">
        <span className="font-mono text-[9px] font-bold tracking-widest text-red-light">{label}</span>
  ...
  return (
    <button
      ...
      className={cn(
        ...
        active
          ? "border-red bg-red/15 text-red-light shadow-[inset_0_0_24px_rgba(227,34,25,0.16)]"
          : "border-white/15 bg-black/15 text-white/65 hover:border-white/45 hover:bg-white/10 hover:text-white",
        disabled && "cursor-not-allowed opacity-40 hover:border-white/15 hover:text-white/65"
      )}
    >
